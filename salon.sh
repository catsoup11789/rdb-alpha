...
echo -e "\n~~~~~ THE SALON ~~~~~\n"
echo -e "Hi! Welcome to The Salon, how can we help you?\n"
...
GET_SERVICES_ID() {
  ...
  case $SERVICE_ID_SELECTED in
    [1-5]) NEXT ;;
        *) GET_SERVICES_ID "Sorry, I could not find that service. What would you like today?" ;;
  esac
}
...
NEXT() {
  ...
  if [[ -z $NAME ]]
  then
    echo -e "\nOh, I don't have a record for that phone number, but I can get you started. What's your name?"
    read CUSTOMER_NAME
  ...
  echo -e "\nPerfect, thank you. What time would you like your $SERVICE_NAME, $CUSTOMER_NAME?"
  read SERVICE_TIME
  ...
  then
    echo -e "\nGreat! I have put you down for a $SERVICE_NAME at $SERVICE_TIME, $CUSTOMER_NAME."
  fi
